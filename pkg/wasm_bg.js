...
* @returns {PhotonImage}
*/
export function new_resizer(source_img, wdth, hgth) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(source_img, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.new_resizer(retptr, ptr0, len0, wdth, hgth);
...
export function __wbg_width_6e17ed358e109a2f(arg0) {
    const ret = getObject(arg0).width;
    return ret;
};

export function __wbg_height_3948020edf838414(arg0) {
